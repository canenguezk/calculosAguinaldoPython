...
def aCercaDe():
    ...
    messagebox.showinfo("Acerca de", "Versión 1.0 PepPock (Karen Cañenguez :D)")
...
root = Tk()
root.title("Calcular Aguinaldo El Salvador")
barraMenu = Menu(root)
